                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-7" style="padding-bottom:120px">
                                <form action="index.php/admin/slide/them" method="post"  enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                    <div class="form-group">
                                        <label>Link</label>
                                        <input class="form-control" name="link" value="{{old('link')}}" placeholder="Please Enter Link" />
                                        @if ($errors->has('link'))
