                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12" style="padding-bottom:120px">
                                <form action="index.php/admin/theloai/them" method="post"  enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="3" class="form-control" name="key_word" value="{{old('key_word')}}"placeholder="Please Enter Key Word" >
                                    ...
                                    <div class="form-group">
                                        <label>Mô Tả</label>
                                        <textarea rows="5" class="form-control" name="mota" placeholder="Please Enter Description" value="{{old('mota')}}" >
