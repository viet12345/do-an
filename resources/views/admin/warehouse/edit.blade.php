                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="product_id" style="width:350px">
                                                ...
                                                @foreach($products as $product)
                                                    <option value="{{$product->id}}" {{(old('product_id') == $product->id) ? 'selected': (($product->id == $item->product_id) ? 'selected': '')}}>{{$product->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="number" value="{{old('number', $item->number)}}" placeholder="Please Enter Number" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Giá</label>
                                            <input class="form-control" name="price" value="{{old('price', $item->price)}}" placeholder="Please Enter Price" />
                                                @if ($errors->has('price'))
                                            <span class="text-danger font-italic font-weight-lighter"
                                ...
                                {{-- </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="pick_up_date" value="{{old('pick_up_date', $item->pick_up_date)}}" placeholder="Please Enter Pick Up Date" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="manufacture_date" value="{{old('manufacture_date', $item->manufacture_date)}}" placeholder="Please Enter Manufacture Date" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="expired_date" value="{{old('expired_date', $item->expired_date)}}" placeholder="Please Enter Expired Date" />
